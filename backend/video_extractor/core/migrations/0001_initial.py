# Generated by Django 4.2.7 on 2026-03-27 18:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_format', models.CharField(choices=[('jpg', 'JPEG'), ('png', 'PNG'), ('webp', 'WebP'), ('bmp', 'BMP')], default='png', max_length=10)),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='folder_configs', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('blur_score', models.FloatField(blank=True, help_text='Blur detection score 0-1', null=True)),
                ('file_size', models.IntegerField(help_text='File size in bytes')),
                ('width', models.IntegerField()),
                ('height', models.IntegerField()),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('config', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='images', to='core.folderconfig')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='captured_images', to=settings.AUTH_USER_MODEL)),
            ],
            options={
