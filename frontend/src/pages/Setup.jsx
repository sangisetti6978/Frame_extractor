...
export default function Setup() {
  ...
  const handleFolderSelect = (e) => {
    ...
    if (files && files.length > 0) {
      ...
      setFormData({ ...formData, folder_path: folderPath })
          ...
          <div style={s.section}>
            ...
            <div style={s.inputRow}>
              <input
                ...
                style={s.input} className="pro-input" placeholder="/path/to/output"
              />
              <button type="button" onClick={openFolderPicker} style={s.btnBrowse} className="pro-btn-browse">
                <FolderIcon /> Browse
              </button>
            </div>
            <input ref={folderInputRef} type="file" webkitdirectory="true" onChange={handleFolderSelect} className="hidden" style={{display: 'none'}} />
            <p style={s.desc}>Where extracted frames will be saved locally</p>
          </div>
