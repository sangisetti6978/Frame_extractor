...
const s = {
  ...
  mesh: {
    ...
    inset: 0,
    background: `
      radial-gradient(ellipse 60% 50% at 75% 50%, rgba(124,58,237,0.2) 0%, transparent 60%),
      radial-gradient(ellipse 50% 40% at 25% 40%, rgba(37,99,235,0.15) 0%, transparent 60%)
    `,
    pointerEvents: 'none',
  },
  grid: {
...
export default function Register() {
  ...
  useEffect(() => {
    const id = 'pro-register-page-styles'
    if (!document.getElementById(id)) {
      const el = document.createElement('style')
      el.id = id
      el.textContent = registerPageStyles
  ...
  return (
    <div style={s.page}>
      ...
      <div style={s.container} className="pro-register-grid">
        {/* ─── Left: Brand + Features ─── */}
        <div style={s.brand} className="pro-brand-side">
          ...
          <h1 style={s.brandTitle}>
            Start extracting{' '}
            <span style={s.brandGradient}>perfect frames today</span>
          </h1>

          <p style={s.brandDesc}>
            Join thousands of creators using professional-grade video frame extraction.
          </p>
        ...
        <div>
          <div style={s.card}>
            ...
            <p style={s.cardDesc}>Get started for free — no credit card required</p>
            ...
            <p style={s.linkRow}>
              ...
              <Link to="/login" style={s.link} className="pro-login-link">
                Sign in here
              </Link>
            </p>
          </div>
